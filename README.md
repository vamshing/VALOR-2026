# VALOR-2026
VALOR is a research framework for uplift modeling developed by Vamshi Guduguntla et. al., specifically designed for revenue optimization in B2B and e-commerce scenarios. It leverages novel techniques to accurately estimate Individual Treatment Effects 
...
- **Baselines**: `slearner`, `tlearner`, `tarnet`, `dragonnet`, `unite`, `euen`
- **VALOR Variants**: `valor_tarnet`, `valor_dragonnet`, `valor_unite`
